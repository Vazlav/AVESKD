...
Процедура ПодготовитьТаблицыДвижений(ТаблицыДвижений)
	...
	Запрос.Текст = "ВЫБРАТЬ
	               ...
	               |ПОМЕСТИТЬ ВТТовары
	               |ИЗ
	               |	Документ.УЗ_Разбраковка.Товар КАК ТЧТовар
	               ...
	               |
	               |////////////////////////////////////////////////////////////////////////////////
				   |// 2. Расход БойБрака из партии бой брака :  УЗ_ПартииБрак
	               |ВЫБРАТЬ
	               |	ВТТовары.СкладКод КАК СкладКод,
	               |	ВТТовары.ФирмаКод КАК ФирмаКод,
	               |	ВТТовары.ВидПоступленияПорядок КАК ВидПоступленияПорядок,
	               ...
	               |;
	               |
				   |// 3. Приход хорошего в ТО + расход БойБрака в ТО :  УЗ_ТоварныйОтчет
	               |////////////////////////////////////////////////////////////////////////////////
	               |ВЫБРАТЬ
	               |	ВТТовары.СкладКод,
	               |	ВТТовары.ФирмаКод,
	               ...
	               |	ВТТовары.ВидПоступленияПорядок,
	               |	ВТТовары.СтавкаНДСЗакуп,
	               |	СУММА(ВТТовары.СуммаЗакупБезНДС),
			...
			ТаблицыДвижений.Вставить("УЗ_ПартииБрак",			                        Результат[2].Выгрузить());
